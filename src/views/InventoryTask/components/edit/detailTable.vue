<template>
  ...
  <div class="ph-table">
    ...
    >
      ...
      <el-table-column prop="warehouseStock.name" label="系统库存" width="100"></el-table-column>
      <el-table-column prop="checkedStock" label="实际盘点库存" width="180" fixed="right" align="center">
