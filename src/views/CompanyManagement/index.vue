      ...
      return {
        ...
        tableConfig: {
          ...
          columns: [
            {type: 'selection'},
            phColumns.id,
            {prop: 'abbreviation', label: '简称',  "min-width": 135, },
            {prop: 'fullName', label: '全称',  "min-width": 120},
            {prop: 'address', label: '地址', "min-width": 120},
            {prop: 'region', label: '区域', sortable: 'custom', "min-width": 120},
            {prop: 'contact', label: '联系人', sortable: 'custom', "min-width": 120},
