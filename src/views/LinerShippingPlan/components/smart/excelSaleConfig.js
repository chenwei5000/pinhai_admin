...
let excelField = [
  ...
  {'attrName': 'productName', 'type': 's', 'name': '#名称#'},
  {'attrName': 'asin', 'type': 's', 'name': '#ASIN#'},
  {'attrName': 'fnSku', 'type': 's', 'name': '#FNSKU#'},
  {'attrName': 'vipLevel', 'type': 's', 'name': '#Vip级别#'},
  ...
  {'attrName': 'formatSoldTime', 'type': 'd', 'name': '#销售截止日#'},
