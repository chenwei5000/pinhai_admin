let excelField = [
  ...
  },
  {
    ...
    'type': 'f',
    'name': '#缺口/库存取小值箱数-公式#',
    'relation': ['#国内库存(箱)#', '#应补箱数-公式#'],
    'formulae': 'MIN(#国内库存(箱)#,#应补箱数-公式#)'
  },
  {
    'attrName': '',
    'type': 'f',
  ...
  },
  {
    ...
    'formulae': 'ROUND((#应发箱数#*#装箱数#+#有效库存(件)#)/#7日销量(件)#,1)+#运输周数#'
  },
  {
    'attrName': '',
    'type': 'f',
    'name': '#最终覆盖周数超过预期2周-公式#',
    'relation': ['#覆盖周数#', '#最终覆盖周数-公式#'],
    'formulae': 'IF((#最终覆盖周数-公式#)>VALUE(#覆盖周数#),#最终覆盖周数-公式#-VALUE(#覆盖周数#),"")'
  },
  {
    'attrName': '',
    'type': 'f',
