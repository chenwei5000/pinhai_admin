<template>
  ...
  <div class="ph-table">
    ...
    >
      ...
      <el-table-column prop="number" label="米数" min-width="100"></el-table-column>
    </el-table>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      //数据 TODO: 根据实际情况调整
      url: "/materialRequisitionItems", // 资源URL
      primaryId: "",
      filters: [
        {
  ...
  methods: {
    ...
    getSummaries(param) {
      ...
      columns.forEach((column, index) => {
        ...
        if (
          column.property == "warehouseStock.qty" ||
          column.property == "checkedStock" ||
          column.property == "stockError"
        ) {
    ...
    getList() {
      ...
      if (this.filters && this.filters.length > 0) {
        params +=
          "?filters=" + JSON.stringify({ groupOp: "AND", rules: this.filters });
      }
      // 处理关联加载
