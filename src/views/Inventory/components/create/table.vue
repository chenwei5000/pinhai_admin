  ...
  export default {
    ...
    methods: {
      ...
      onToolBarDownloadTpl() {
        ...
        this.tplNoExportProps.push(this.typeName + "箱数");
        ...
        if (!detailItem.skuCode) {
          ...
          return this.global.axios
            ...
            .then(resp => {
              ...
              if (detailItem.numberOfCarton == null) {
              ...
              if (detailItem.number && detailItem.numberOfCarton) {

                detailItem.cartonQty = (detailItem.number / detailItem.numberOfCarton).toFixed(3);
              } else {
                detailItem.cartonQty = 0;
              }
      ...
      async onToolBarImportData(excelData) {
        ...
        excelData.results.forEach(obj => {
          ...
          _res["number"] = obj[this.typeName + "件数"];
          resData.push(_res);
        });
