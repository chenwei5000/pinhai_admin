      ...
      <el-row>
        <el-col :md="10">
          <el-form-item label="收货数量" prop="receivedQty">
            <el-input v-model="detailItem.receivedQty" style="width: 220px" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :md="10">
          <el-form-item label="异常备注" prop="receivedNote">
            <el-input v-model="detailItem.receivedNote" style="width: 220px" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
