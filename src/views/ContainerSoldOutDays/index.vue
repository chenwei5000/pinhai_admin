    ...
    <div class="ph-card">
      <div class="ph-card-body">
          ...
          <el-table
            ...
            <el-table-column prop="fnSku" label="FNSKU" width="200"></el-table-column>
            <el-table-column prop="groupName" label="产品款式" width="200" ></el-table-column>
    ...
    data() {
      return {
        ...
        tableAttrs: {
          ...
          columns: [
            {type: 'selection'},
            {prop: 'id', label: 'ID', "min-width": 120, hidden:'false'},
