  ...
  <div class="ph-table">
    ...
    <el-form :inline="true" :model="searchParam" ref="searchForm" id="filter-form"
      ...
      <el-form-item label="名称">
        <el-input v-model="searchParam.name.value" size="mini" placeholder="请输入名称"></el-input>
      </el-form-item>

      <el-form-item label="状态">
        <el-select v-model="searchParam.status.value" size="mini" placeholder="请选择状态">
    ...
    >
      ...
      <el-table-column prop="name" label="名称" min-width="250" fixed="left"></el-table-column>
      <el-table-column prop="status" label="状态" width="100">
        <template slot-scope="scope">
          <el-tag
            :type="scope.row.status === 1 ? 'success' : 'info'"
            disable-transitions>{{ scope.row.status === 1 ? '启用' : '关闭' }}
          </el-tag>
        </template>
      </el-table-column>
