let dataFormat1 = [
  ...
  { 'attrName': 'vipType', 'type': 'n', 'name': '#Vip级别#' },
...
let dataFormat2 = [
  { 'attrName': '', 'type': 's', 'name': '#SKU编码#' },
  { 'attrName': '', 'type': 's', 'name': '#产品名#' },
  { 'attrName': '', 'type': 's', 'name': '#分类#' },
  { 'attrName': '', 'type': 'n', 'name': '#Vip级别#' },
  { 'attrName': '', 'type': 's', 'name': '#箱规#' },
  { 'attrName': '', 'type': 'n', 'name': '#装箱数#' },
  { 'attrName': '', 'type': 'n', 'name': '#托盘装箱数#' },
  { 'attrName': '', 'type': 'n', 'name': '#7日销量(件)#' },
  { 'attrName': '', 'type': 'n', 'name': '#备货周数#' },
  { 'attrName': '', 'type': 'n', 'name': '#需求总量(箱)#' },
  { 'attrName': '', 'type': 'n', 'name': '#在途加亚马逊库存(件)#' },
  { 'attrName': '', 'type': 'n', 'name': '#国内库存(箱)#' },
  { 'attrName': '', 'type': 'n', 'name': '#未完成采购计划数(箱)#' },
  { 'attrName': '', 'type': 'n', 'name': '#采购箱数#' },
  { 'attrName': '', 'type': 'f', 'name': '#采购件数-公式#', 'relation': ['装箱数', '采购箱数'], 'formulae': '#采购箱数#*#装箱数#' },
  { 'attrName': '', 'type': 'f', 'name': '#可售周数-公式#', 'relation': ['装箱数', '7日销量(件)', '在途加亚马逊库存(件)', '国内库存(箱)', '未完成采购计划数(箱)', '采购箱数'], 'formulae': 'IF(#7日销量(件)#>0,ROUND(((#采购箱数#+#国内库存(箱)#+#未完成采购计划数(箱)#)*#装箱数#+#在途加亚马逊库存(件)#)/#7日销量(件)#,1),0)' },
  { 'attrName': '', 'type': 'f', 'name': '#可售周数超过预期2周-公式#', 'relation': ['备货周数', '可售周数-公式'], 'formulae': 'IF((#可售周数-公式#-2)>VALUE(#备货周数#),#可售周数-公式#-VALUE(#备货周数#),"")' }
]
